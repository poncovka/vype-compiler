...
vype:	lexer.o parser.tab.o symtable.o driver.o error.o generator.o vype.o
	c++ -g -o vype vype.o error.o generator.o driver.o symtable.o parser.tab.o lexer.o -lm
